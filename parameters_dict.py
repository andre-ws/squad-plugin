parameters_desc = {
	"ADMIN_UNITS_LAYER": "Browse to a polygon feature class containing the administrative units into which the sites are expected to fall. This file will be used to gauge the geographic accuracy of the site locations. "
